...
class base_gun{
    ...
    public:
        ...
        void gun_move_and_fire(RenderWindow &window, std::vector<bullet> &bullet_vector, Vector2f target_pos ,Vector2f owner_pos){// for up down movement bcs of mouse
            Vector2f owner_pos_adj = {owner_pos.x + 10, owner_pos.y+25};
            float delta_x_to_entity = target_pos.x - owner_pos_adj.x;
            float delta_y_to_entity = target_pos.y - owner_pos_adj.y ;
            ...
            gun_body.setPosition(owner_pos_adj) ;
